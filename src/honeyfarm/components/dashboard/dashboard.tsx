...
import { RequestAgentList, RequestServerList, RequestSensorList } from '../../honeyfarmActions';
...
class Dashboard extends React.Component<Props, State> {
	...
	componentWillMount() {
		...
		dispatch(new RequestAgentList({ page: 1, perPage: 20 }));
		dispatch(new RequestSensorList({ page: 1, perPage: 20 }));
	}
					...
					<Col xs="12" sm="6" lg="3">
						<Card className="text-white bg-warning">
							<CardBody className="pb-0">
								...
								<div className="text-value">1.493</div>
								<div>Unique attackers / hour</div>
							</CardBody>
						...
						<Card>
							<CardBody>
								<Row>
									<Col sm="5">
										<CardTitle
											className="mb-0">Events</CardTitle>
										<div className="small text-muted">May
											2018
										</div>
									</Col>
									<Col sm="7"
							...
							<CardFooter>
								<Row className="text-center">
									<Col sm={12} md className="mb-sm-2 mb-0">
										<div className="text-muted">Bot</div>
										<strong>Mirai (40%)</strong>
									...
									<Col sm={12} md
										...
										<strong>24.093 events (20%)</strong>
										<Progress className="progress-xs mt-2"
												  color="info" value="20"/>
									</Col>
									<Col sm={12} md className="mb-sm-2 mb-0">
										<div className="text-muted">Pageviews
										</div>
									...
									<Col sm={12} md className="mb-sm-2 mb-0">
										<div className="text-muted">New Users
										</div>
							...
							<CardBody>
								<Table hover responsive
									...
									<tr>
										<td>
											<span
												className="badge badge-danger">Offline</span>
										</td>
										<td>
											<div className="">
												Agent02
										...
										<td>
											<span
												className="badge badge-info">ssh</span>&nbsp;
											<span
												className="badge badge-info">ethereum</span>&nbsp;
											<span
												className="badge badge-info">vnc</span>
										</td>
									</tr>
									</tbody>
								</Table>
